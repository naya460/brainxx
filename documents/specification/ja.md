...
数字の文字列を`__num_str__`と記述します。  
`__num__`では1と01は同一ですが、`__num_str__`では別のものとして扱います。  
...
## 関数
- `#:__num_str__` fn def  
    fn__num_str__形式の関数を宣言する。  

- `#>__num_str_1__:__num_str_2__` fn call  
    fn__num_str_1__関数を__num_str_2__個を引数としてpopし、返り値をpushする。  
